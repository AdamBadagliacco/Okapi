...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
    	...
    	//Create a HashMap to store the student data. The key is their ID #, the value is a Student object
        ...
        //Sends a POST request to "/challenge" with the JSON data specified in the coding challenge instructions
        postRequest("adambadagliacco@gmail.com", "Adam Badagliacco", (int)testAverage, femaleCS);
    }
    
    public static void postRequest(String id, String name, int average, ArrayList<String> studentIds) throws IOException{
